...
//        tv1.setText("Year: "+view.getYear()+" Month: "+view.getMonth()+" Day: "+view.getDayOfMonth());
        EditText mData = (EditText) getActivity().findViewById(R.id.editText_data);
        mData.setText("");
        mData.setText(String.format("%02d",view.getDayOfMonth()) + "/" + String.format("%02d",(view.getMonth() + 1)) + "/" + String.format("%04d",(view.getYear())));
